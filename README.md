...
Проект не сводится к “поиску похожих треков”. Основной сценарий такой:

`EEG -> emotion inference -> melody generation -> music matching -> emotion validation`
...
Для защиты удобно сравнивать как минимум `4 s` и `8 s` на одном и том же подмножестве EEG/классики.
